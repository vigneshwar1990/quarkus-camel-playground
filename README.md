...
2. Visit the `/hello` endpoint: [http://127.0.0.1:8080/hello](http://127.0.0.1:8080/hello)
    - Update the response in [src/main/java/org/acme/quickstart/GreetingResource.java](src/main/java/org/vignesh/quarkus/GreetingResource.java). Replace `hello` with `hello there` in the `hello()` method.
